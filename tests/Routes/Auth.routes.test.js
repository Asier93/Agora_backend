...
describe('Auth Controller', () => {
  ...
  describe('Register', () => {
    it('should register a new user', async () => {
      ...
      expect(response.body).toEqual({ message: "You've been registered successfully" });
    });
    ...
    it('should handle registration error', async () => {
      ...
      expect(response.status).toBe(400); // Verificar que el estado sea 500
      expect(response.body).toEqual({ message: 'The email or username already exists' });
    });
  });
